...
epsilon_MDP = dp4.MarkovGridWorld(grid_size=epsilon_grid_size, direction_probability=1, obstacles=epsilon_obstacles, landing_zone=epsilon_landing_zone, max_altitude=epsilon_max_altitude)
