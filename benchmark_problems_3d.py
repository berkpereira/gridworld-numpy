...
wind_MDP = dp3.MarkovGridWorld(grid_size=wind_grid_size, direction_probability=1, obstacles=wind_obstacles, landing_zone=wind_landing_zone, max_altitude=wind_max_altitude)
...
epsilon_MDP = dp3.MarkovGridWorld(grid_size=epsilon_grid_size, direction_probability=epsilon_eval_wind, obstacles=epsilon_obstacles, landing_zone=epsilon_landing_zone, max_altitude=epsilon_max_altitude)
...
"""
# NOTICE DIFFERENT CONCLUDED EPSILON PARAMETER FOR USE
ratio_episodes_steps_epsilon = 0.1 # as per what was concluded in epsilon investigations

ratio_episodes_steps_ratio_params = np.linspace(0.05, 0.5, 10) # 0.05, 0.10, ..., 0.45, 0.50
